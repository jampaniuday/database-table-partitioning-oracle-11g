...
-- performance_sample --
EXECUTE IMMEDIATE 'CREATE INDEX UPTIMEHOST_ID 
ON PERFORMANCE_SAMPLE ("UPTIMEHOST_ID")  local';
EXECUTE IMMEDIATE 'CREATE INDEX SAMPLE_ERDC_ID
ON PERFORMANCE_SAMPLE ("ERDC_ID") local';
EXECUTE IMMEDIATE 'CREATE INDEX LATEST_SAMPLE
ON PERFORMANCE_SAMPLE ("ERDC_ID", "SAMPLE_TIME") local';

EXECUTE IMMEDIATE 'CREATE INDEX LATEST_SAMPLE_BY_HOST
ON PERFORMANCE_SAMPLE ("UPTIMEHOST_ID", "SAMPLE_TIME") local';
...
-- performance_cpu --
EXECUTE IMMEDIATE 'CREATE INDEX CPU_SAMPLE_ID 
ON PERFORMANCE_CPU ("SAMPLE_ID") local';


-- performance_disk --
EXECUTE IMMEDIATE 'CREATE INDEX DISK_SAMPLE_ID 
ON PERFORMANCE_DISK ("SAMPLE_ID") local';
...
EXECUTE IMMEDIATE 'CREATE INDEX IDX_102 
ON PERFORMANCE_ESX3_WORKLOAD ("SAMPLE_ID") local';


-- performance_fscap --
EXECUTE IMMEDIATE 'CREATE INDEX FSCAP_SAMPLE_ID 
ON PERFORMANCE_FSCAP ("SAMPLE_ID") local';


-- performance_lpar_worload --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_100 
ON PERFORMANCE_LPAR_WORKLOAD ("SAMPLE_ID") local';


-- performance_network --
EXECUTE IMMEDIATE 'CREATE INDEX NETWORK_SAMPLE_ID 
ON PERFORMANCE_NETWORK ("SAMPLE_ID") local';
...
-- performance_psinfo --
EXECUTE IMMEDIATE 'CREATE INDEX PSINFO_SAMPLE_ID 
ON PERFORMANCE_PSINFO ("SAMPLE_ID") local';


-- performance_vxvol --
EXECUTE IMMEDIATE 'CREATE INDEX VXVOL_SAMPLE_ID 
ON PERFORMANCE_VXVOL ("SAMPLE_ID") local';


-- performance_who --
EXECUTE IMMEDIATE 'CREATE INDEX WHO_SAMPLE_ID 
ON PERFORMANCE_WHO ("SAMPLE_ID") local';


-- erdc_int_data --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_SVC_METRICS_INT
ON ERDC_INT_DATA ("ERDC_PARAMETER_ID", "ERDC_INSTANCE_ID", "SAMPLETIME") local';


-- erdc_decimal_data --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_SVC_METRICS_DEC
ON ERDC_DECIMAL_DATA ("ERDC_PARAMETER_ID", "ERDC_INSTANCE_ID", "SAMPLETIME") local';


-- erdc_string_data --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_SVC_METRICS_STR
ON ERDC_STRING_DATA ("ERDC_PARAMETER_ID", "ERDC_INSTANCE_ID", "SAMPLETIME") local';


-- ranged_object_value --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_042
ON RANGED_OBJECT_VALUE ("RANGED_OBJECT_ID") local';

EXECUTE IMMEDIATE 'CREATE INDEX RANGED_NAME_IDX
ON RANGED_OBJECT_VALUE ("NAME") local';

EXECUTE IMMEDIATE 'CREATE INDEX RANGED_SAMPLE_TIME_IDX
ON RANGED_OBJECT_VALUE ("SAMPLE_TIME") local';
...
--vmware_perf_sample -- 	
EXECUTE IMMEDIATE 'CREATE INDEX VM_PERF_SAMPLE_TIME
ON VMWARE_PERF_SAMPLE ("SAMPLE_TIME") local';
	
EXECUTE IMMEDIATE 'CREATE INDEX VM_PERF_SAMPLE_VMOID_TIME
ON VMWARE_PERF_SAMPLE ("VMWARE_OBJECT_ID","SAMPLE_TIME") local';
...
EXECUTE IMMEDIATE 'CREATE INDEX IDX_DATASTORE_VM_USAGE_SAMPLE
ON VMWARE_PERF_DATASTORE_VM_USAGE ("SAMPLE_ID") local';
...
EXECUTE IMMEDIATE 'CREATE INDEX IDX_HOST_CPU_SAMPLE
ON VMWARE_PERF_HOST_CPU ("SAMPLE_ID") local';

-- VMWARE_PERF_HOST_DISK_IO --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_HOST_DISK_SAMPLE
ON VMWARE_PERF_HOST_DISK_IO ("SAMPLE_ID") local';

-- VMWARE_PERF_HOST_DISK_IO_ADV --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_HOST_DISK_ADV_SAMPLE
ON VMWARE_PERF_HOST_DISK_IO_ADV ("SAMPLE_ID") local';

-- VMWARE_PERF_HOST_Network --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_HOST_NETWORK_SAMPLE
ON VMWARE_PERF_HOST_NETWORK ("SAMPLE_ID") local';
...
EXECUTE IMMEDIATE 'CREATE INDEX IDX_VM_DISK_ADV_SAMPLE
ON VMWARE_PERF_VM_DISK_IO ("SAMPLE_ID") local';

-- VMWARE_PERF_VM_NETWORK --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_VM_NETWORK_SAMPLE
ON VMWARE_PERF_VM_NETWORK ("SAMPLE_ID") local';
...
-- VMWARE_PERF_VM_VCPU --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_VM_VCPU_SAMPLE
ON VMWARE_PERF_VM_VCPU ("SAMPLE_ID") local';
...
EXECUTE IMMEDIATE 'CREATE INDEX IDX_NET_DEV_PERF_PING_SAMPLE
ON NET_DEVICE_PERF_PING ("SAMPLE_ID") local';

-- NET_DEVICE_PERF_PORT --
EXECUTE IMMEDIATE 'CREATE INDEX IDX_NET_DEV_PERF_PORT_SAMPLE
ON NET_DEVICE_PERF_PORT ("SAMPLE_ID") local';
